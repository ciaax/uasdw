         ...
         <div class="row">
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            ...
		            <input type="text" name="transID" class="form-control" placeholder="Transaction ID">
		        </div>
		    </div>
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            ...
		            <input type="number" name="fineDays" class="form-control" placeholder="Fine Days">
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Fine:</strong>
		            <input type="number" name="fine" class="form-control" placeholder="Fine">
		        </div>
		    </div>
